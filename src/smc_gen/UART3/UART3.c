...
void R_UART3_Create(void)
{
    ...
    SCI12.SMR.BYTE = _01_SCI_CLOCK_PCLK_4 | _00_SCI_MULTI_PROCESSOR_DISABLE | _00_SCI_STOP_1 | 
    ...
    SCI12.SEMR.BYTE = _00_SCI_BIT_MODULATION_DISABLE | _00_SCI_16_BASE_CLOCK | _00_SCI_NOISE_FILTER_DISABLE | 
...
/***********************************************************************************************************************
* Function Name: R_UART3_Serial_Receive
...
MD_STATUS R_UART3_Serial_Receive(uint8_t * const rx_buf, uint16_t rx_num)
{
...
/***********************************************************************************************************************
* Function Name: R_UART3_Serial_Send
...
MD_STATUS R_UART3_Serial_Send(uint8_t * const tx_buf, uint16_t tx_num)
{
    MD_STATUS status = MD_OK;
