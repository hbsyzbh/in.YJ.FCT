...
/***********************************************************************************************************************
* Function Name: R_SPI_Create_UserInit
...
/***********************************************************************************************************************
* Function Name: r_SPI_transmit_interrupt
* Description  : This function is SPTI0 interrupt service routine
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

void r_SPI_transmit_interrupt(void)
{
    uint16_t frame_cnt;
...
/***********************************************************************************************************************
* Function Name: r_SPI_receive_interrupt
...
/***********************************************************************************************************************
* Function Name: r_SPI_error_interrupt
* Description  : This function is SPEI0 interrupt service routine
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

void r_SPI_error_interrupt(void)
{
    uint8_t err_type;
...
/***********************************************************************************************************************
* Function Name: r_SPI_callback_transmitend
...
/***********************************************************************************************************************
* Function Name: r_SPI_callback_receiveend
...
/***********************************************************************************************************************
* Function Name: r_SPI_callback_error
...
static void r_SPI_callback_error(uint8_t err_type)
{
    /* Start user code for r_SPI_callback_error. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}
